...
public class UserExhibitionHallVO {
	...
	public UserExhibitionHallVO(String ex_name, String adress1, String adress2, String mgr_name, String mgr_tel,
	...
	public String toString() {
		return "UserExhibitionHallVO [ex_name=" + ex_name + ", adress1=" + adress1 + ", adress2=" + adress2
